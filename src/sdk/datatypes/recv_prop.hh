...
using recv_var_proxy_fn = void(*)(recv_proxy_data_t*, void*, void*);
...
struct recv_prop_hook_t {
	...
	ALWAYS_INLINE void hook(recv_var_proxy_fn proxy_fn) {
		m_original = m_prop->m_proxy_fn;
		m_prop->m_proxy_fn = proxy_fn;
	}

	ALWAYS_INLINE void unhook() { m_prop->m_proxy_fn = m_original; }

	ALWAYS_INLINE recv_var_proxy_fn get_original() { return m_original; }
